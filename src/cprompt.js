...
var cPrompt = {
	...
	loadPrompt: function(){
		...
		holder.innerHTML = "<div style='margin: 10px;'>This site would like to place cookies on your computer to help make this website better. To find out more about the cookies, visit <a href='en.wikipedia.org/wiki/HTTP_cookie' style='color: #FFF;'>Wikipedia</a>.<br /><input type='checkbox' onclick='cPrompt.clickEvent(this);'> I accept cookies from this site.</div>"
